...
def math : ParserT ε s Char Pos m Char :=
...
def parseGeneralCategory (category : Unicode.GC) : ParserT ε s Char Pos m Char :=
...
def lowercaseLetter : ParserT ε s Char Pos m Char :=
...
def uppercaseLetter : ParserT ε s Char Pos m Char :=
...
def titlecaseLetter : ParserT ε s Char Pos m Char :=
...
def modifierLetter : ParserT ε s Char Pos m Char :=
...
def otherLetter : ParserT ε s Char Pos m Char :=
...
def mark : ParserT ε s Char Pos m Char :=
...
def spacingMark : ParserT ε s Char Pos m Char :=
...
def nonspacingMark : ParserT ε s Char Pos m Char :=
...
def enclosingMark : ParserT ε s Char Pos m Char :=
...
def number : ParserT ε s Char Pos m Char :=
...
def decimalNumber : ParserT ε s Char Pos m Char :=
...
def letterNumber : ParserT ε s Char Pos m Char :=
...
def otherNumber : ParserT ε s Char Pos m Char :=
...
def punctuation : ParserT ε s Char Pos m Char :=
...
def connectorPunctuation : ParserT ε s Char Pos m Char :=
...
def dashPunctuation : ParserT ε s Char Pos m Char :=
...
def openPunctuation : ParserT ε s Char Pos m Char :=
...
def closePunctuation : ParserT ε s Char Pos m Char :=
...
def initialPunctuation : ParserT ε s Char Pos m Char :=
...
def finalPunctuation : ParserT ε s Char Pos m Char :=
...
def otherPunctuation : ParserT ε s Char Pos m Char :=
...
def currencySymbol : ParserT ε s Char Pos m Char :=
...
def modifierSymbol : ParserT ε s Char Pos m Char :=
...
def otherSymbol : ParserT ε s Char Pos m Char :=
...
def separator : ParserT ε s Char Pos m Char :=
...
def spaceSeparator : ParserT ε s Char Pos m Char :=
...
def lineSeparator : ParserT ε s Char Pos m Char :=
...
def paragraphSeparator : ParserT ε s Char Pos m Char :=
...
def other : ParserT ε s Char Pos m Char :=
...
def format : ParserT ε s Char Pos m Char :=
...
def surrogate : ParserT ε s Char Pos m Char :=
...
def privateUse : ParserT ε s Char Pos m Char :=
...
def noncharacter : ParserT ε s Char Pos m Char :=
